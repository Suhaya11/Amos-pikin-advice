...
import { Data, myData, wahala } from "../data";
import { BiPause, BiPlay, BiStop } from "react-icons/bi";

type myProps = {
  wahala: wahala;
};
const WahalaCard = ({ wahala }: myProps) => {
  ...
  return (
    <div className="flex text-white relative flex-row flex-wrap gap-3 justify-center border my-2 mx-auto w-11/12 p-2 from-green-700 to-amber-500 cursor-default bg-linear-to-r rounded-xl ">
      ...
      <p onClick={(e) => loudReading && sayLaud(e.currentTarget.textContent)}>
        {" "}
        {wahala.desctiption}
      </p>
